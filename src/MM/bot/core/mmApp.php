...
class mmApp
{
     ...
     *  - array db Настройка подключения к базе данных. Актуально если IS_SAVE_DB = true.
     ...
     *      - Заполняется автоматически.
     * - string|null welcome_text Текст приветствия.
     * - string|null help_text Текст помощи.
