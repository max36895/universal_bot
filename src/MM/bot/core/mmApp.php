...
defined('T_SMARTAPP') or define('T_SMARTAPP', 'smart_app');     // Используется Сбер SmartApp
defined('T_USER_APP') or define('T_USER_APP', 'user_application');  // Используется пользовательский тип приложения

defined('WELCOME_INTENT_NAME') or define('WELCOME_INTENT_NAME', 'welcome'); // Название интента для приветствия
...
class mmApp
{
     ...
     *  - bool isLocalStorage Использование локального хранилища вместо БД. Актуально для приложений, который поддерживают работу с ним. На данный момент, локальное хранилище есть у всех голосовых помощников.
     ...
     *      - Заполняется автоматически.
     * - string|string[]|null welcome_text Текст, или массив из текста для приветствия.
     * - string|string[]|null help_text Текст, или массив из текста для помощи.
