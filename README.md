...
Документация
------------
Документация: [https://www.maxim-m.ru/bot/documentation/index.html](https://www.maxim-m.ru/bot/documentation/index.html). Для получения информации о работе приложения можно в телеграм канале [MM](https://t.me/joinchat/AAAAAFM8AcuniLTwBLuNsw) или группе [MM](https://t.me/mm_universal_bot)
...
По умолчанию все данные записываются в файл, для того, чтобы использовать базу данных, нужно установить переменную `IS_SAVE_DB` в `true`.
Делается это следующим образом:
```php
defined('IS_SAVE_DB') or define('IS_SAVE_DB', true);
```
После создать базу данных одним из способов:
