...
Документация
------------
Документация находится по адресу: [https://www.maxim-m.ru/bot/documentation/index.html](https://www.maxim-m.ru/bot/documentation/index.html). Для получения информации о работе можно в телеграм канале [MM](https://t.me/joinchat/AAAAAFM8AcuniLTwBLuNsw) или в группе [MM](https://t.me/mm_universal_bot)
...
При необходимости есть возможность создать приложение определенного типа (`alisa`, `vk`, `telegram`, `viber`, `маруся`), либо создать свой тип.
...
$bot->initBotController((new LocalStorageController())); // Инициализация логики приложения
